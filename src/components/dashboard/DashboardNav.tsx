...
import { Inbox, FileText, BookOpen, MessageSquare, User, Settings, Layout, PenTool, Beaker } from 'lucide-react';

const DashboardNav = () => {
  const links = [
    { to: "/dashboard", icon: <Layout size={18} />, label: "Overview", exact: true },
    { to: "/dashboard/messages", icon: <Inbox size={18} />, label: "Messages" },
    { to: "/dashboard/research", icon: <Beaker size={18} />, label: "Research" },
